...
public class ChatClientSwing extends JFrame {
    ...
    private Usuario USER_GERAL = new Usuario("Geral", null, null, null);
    ...
    public ChatClientSwing() throws UnknownHostException {
        ...
        this.meuUsuario = new Usuario(nomeUsuario,
                InetAddress.getLocalHost(),
                Usuario.StatusUsuario.DISPONIVEL, null);
        udpService.usuarioAlterado(meuUsuario);
